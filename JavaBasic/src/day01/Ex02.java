...
public class Ex02 {
	public static void main(String[] args) {
		...
		//해당 메모리 위치에 실제값이 아니라 heap 영역 메모리 주소값이 들어가면
		//참조형
		...
		//||: or 연산 -> 2개중 하나만 true여도 true
		//!: 반전 연산 -> true는 false로, false는 true로
		...
		//& 연산: 2진법 으로 변환후 두 숫자의 같은 자리가 모두 1이면 1
		...
		// << 연산: 왼쪽 쉬프트 연산. 자릿수를 왼쪽으로 이동시킨다.
		System.out.println(myByte << 2); 
		//0000 0011 << 2
		//0000 001100 -> 10자리 but 바이트는? 8자리
		//앞에 두자리를 지워준다.
		//0000 1100
